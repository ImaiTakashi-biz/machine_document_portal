...
1400〜1699pxでは、1920×1080のWindows PCを表示倍率125%で利用した場合も5列を維持できるよう、資料列とボタンを少しコンパクトにします。680px以下では号機グループを折りたため、初期表示は最初のグループだけを開きます。省略されやすい品番・品名は折り返して表示し、資料ボタンやメニューボタンは44px以上のタッチ領域を確保します。iPhone／iPadのセーフエリアと動的なブラウザ高さにも対応しています。
